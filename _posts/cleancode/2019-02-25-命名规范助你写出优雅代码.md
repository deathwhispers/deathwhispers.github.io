...
layout: post
title: 命名规范，助你写出优雅代码
slug: naming-conventions-for-clean-code
type:
  - note
date: 2019-02-25
tags:
...
大名鼎鼎的《重构》的作者老马（Martin Fowler）曾经在[TwoHardThingsopen in new window](https://martinfowler.com/bliki/TwoHardThings.html)这篇文章中提到过CS 领域有两大最难的事情：一是 **缓存失效** ，一是 **程序命名** 。

![](/assets/images/cleancode/naming-conventions-for-clean-code/1698036063215-a940ccb2-72cd-4c2d-8530-28432a948b12.png)

这个句话实际上也是老马引用别人的，类似的表达还有很多。比如分布式系统领域有两大最难的事情：一是 **保证消息顺序** ，一是 **严格一次传递** 。

![](/assets/images/cleancode/naming-conventions-for-clean-code/1698036063294-3958a8f6-2f28-4bb1-8033-caac18155c52.png)

今天咱们就单独拎出 “**命名**” 来聊聊！

这篇文章配合我之前发的 [《编码 5 分钟，命名 2 小时？史上最全的 Java 命名规范参考！》open in new window](https://mp.weixin.qq.com/s?__biz=Mzg2OTA0Njk0OA%3D%3D&mid=2247486449&idx=1&sn=c3b502529ff991c7180281bcc22877af&chksm=cea2443af9d5cd2c1c87049ed15ccf6f88275419c7dbe542406166a703b27d0f3ecf2af901f8&token=999884676&lang=zh_CN#rd) 这篇文章阅读效果更佳哦！
...
```java
@Testvoid should_get_200_status_code_when_request_is_valid() {......}
```
...
![](/assets/images/cleancode/naming-conventions-for-clean-code/1698036063379-288907ba-92cf-4f4c-97ce-73470688ac92.png)
...
Codelf 提供了在线网站版本，网址：[https://unbug.github.io/codelf/open in new window](https://unbug.github.io/codelf/)，具体使用情况如下：

我选择了 Java 编程语言，然后搜索了“序列化”这个关键词，然后它就返回了很多关于序列化的命名。

![](/assets/images/cleancode/naming-conventions-for-clean-code/1698036063457-9a82da0e-14cb-4f74-bd49-7c89e2cc8c3c.png)

并且，Codelf 还提供了 VS code 插件，看这个评价，看来大家还是很喜欢这款命名工具的。

![](/assets/images/cleancode/naming-conventions-for-clean-code/1698036063551-847a44ce-aafd-49bf-a3af-c42430766a39.png)
...
4. 告别编码5分钟，命名2小时！史上最全的Java命名规范参考：[https://www.cnblogs.com/liqiangchn/p/12000361.html](https://www.cnblogs.com/liqiangchn/p/12000361.html)
