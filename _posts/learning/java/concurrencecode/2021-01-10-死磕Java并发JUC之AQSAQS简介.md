---
layout: post
title: 死磕Java并发：J.U.C之AQS：AQS简介
slug: concurrent-source-code-aqs-introduction
type:
  - note
date: 2021-01-10
week: 2025-W48
...
- acquire(int arg)**可重写**
：独占式获取同步状态。如果当前线程获取同步状态成功，则由该方法返回；否则，将会进入同步队列等待。该方法将会调用
的
#tryAcquire(int arg)
方法；
...
2. 方腾飞：《Java 并发编程的艺术》的 [「5.2 队列同步器」](https://www.iocoder.cn/JUC/sike/aqs-0-intro/#)
章节。
