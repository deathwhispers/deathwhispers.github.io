...
![JShell 示例](https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/java-guide-blog/image-20210816083417616.png)
...
![模块结构示例](https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/java-guide-blog/module-structure.png)
...
objectOptional.ifPresentOrElse(
System.out::println,
...
Optional<Object> objectOptional = Optional.empty();
objectOptional.or(() -> Optional.of("java"))
...
![ProcessHandle 接口概览](https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/java-guide-blog/image-20210816104614414.png)
