...
date: 2024-03-09
slug: java11-new-features-overview
categories:
- Java
tags:
- Java
type: note
status: draft
created: 2024-03-09 09:54
updated: 2024-03-09 09:54
week: 2025-W48
---
...
![](/assets/images/learning/java/java11-new-features-overview/c015bb45620435f70e302531d826525d.png)
...
```java
// 下面两者是等价的Consumer<String> consumer = (var i) -> System.out.println(i);Consumer<String> consumer = (String i) -> System.out.println(i);
```
...
- [上一篇：Java10 新特性概览](/posts/java10-new-features-overview/)
- [下一篇：Java12~13 新特性概览](/posts/java12-13-new-features-overview/)
