...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698037624188-313bf300-d8d1-46ec-b423-566c37edca48.png)

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698037624282-ddce1aac-a192-4f4b-a437-62f5b6378ec5.png)
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698037624370-2bd6bbcf-4d79-45a5-9695-4bfd9f862b96.png)

## **日志分析**

Data文件按照日期分组统计大小：

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698037624450-64eb2afa-d504-4ffd-abb2-082e4cbf0dd2.png)
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698037624529-45d0ad24-83b5-42fd-a605-b663bbae070b.png)
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698037624609-f4d0fc1e-a759-445e-b666-e994286765ff.png)

左图中CPU很高的部分，以及右图比较平滑的部分，是在做内存抽样操作。这时候内存中的数据不会被YGC释放，所以一直上升

Zabbix观察老年代的占用从10G到15G差不多20分钟一次（红色），而黄色部分是新生代，则很频繁

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698037624700-b8ff6732-0a86-47a5-bcdd-9a644241f727.png)

通过jstat观察，Eden基本上一秒增长1G，和jvisualvm的观察结果一致

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698037624786-57c852c8-a63d-47f3-a514-bfcd12f7f32e.png)

grafana的观察结果，162机器与其他机器Old的变化也比较频繁，而且跟zabbix的波浪状态类似

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698037624888-418ed5be-f3c5-4d91-b9d1-889624816fcd.png)

对应的YoungGC也比其他机器的耗时要高（最上面的绿色曲线）

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698037624973-e4e0ecaf-ca28-4fe0-8f2b-bbae9b1a7a28.png)
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698037625069-511cc713-554b-4b11-9376-882ff3a72485.png)

上图中右侧部分，也是在做抽样，CPU中间部分几乎为0的是在做heap dump

如果用jstat看的话，其实Eden的变化还是几乎1s1G，不过Eden实际上是分配在堆外的，jstat无法反映内存分配在堆内还是堆外

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698037625149-646176d5-dd60-4143-a3f4-771bc80da44b.png)

下面是内存的抽样，有三种类型占用很大，byte[],HeapByteBuffer,int[]

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698037625235-a7eee5eb-f412-4366-987f-0d74ffc0590e.png)
