...
![SKU、SPU、商品关系图](assets/images/learning/database/database-entity-design-product-information/1698040346513-79ca87e0-2d92-45d0-88a1-c3afac8d705b.png)
...
![商品销售组合单元示例](assets/images/learning/database/database-entity-design-product-information/1698040346602-6605a37b-38c8-4d74-a535-46efb140052e.png)
- 一个商家会在不同平台销售商品，例如三只松鼠，其在天猫、京东等等平台都有官方旗舰店，同时也供货给其他渠道商，那么实际关系会变成如下图所示：
![多平台销售商品关系图](assets/images/learning/database/database-entity-design-product-information/1698040346727-9103a318-02eb-4860-865b-dc547ad7e229.png)
...
1. 商城端-购买页
![商城端购买页界面](assets/images/learning/database/database-entity-design-product-information/1698040346819-0c4696d3-d0d4-4655-bcfe-0476db4c4a7a.png)
2. 运营后台-商品发布页
![运营后台商品发布页界面](assets/images/learning/database/database-entity-design-product-information/1698040346933-3af4dbbf-809c-4a2e-97f6-0a706ae5d2a4.png)

# 3. 数据库实体

整体实体类关系如下图：

![整体实体类关系图](assets/images/learning/database/database-entity-design-product-information/1698040347030-8ad15807-fa18-4ac8-8a76-dabd0222a544.png)
...
![分销市场界面](assets/images/learning/database/database-entity-design-product-information/1698040347114-cb58283a-d95f-453d-9a43-10ef27932cd9.png)
...
![会员折扣界面](assets/images/learning/database/database-entity-design-product-information/1698040347216-fb235246-6884-4565-877f-342517c25dd8.png)
...
deliveryTemplateId
。
![运费模板设置界面](assets/images/learning/database/database-entity-design-product-information/1698040347355-40a80491-a0d5-495b-a7d6-7116ab79a8ae.png)
运费模板的操作见 ：
文章。
...
，已下架，在仓库，用户不可见。
    -
![商品上架状态界面](assets/images/learning/database/database-entity-design-product-information/1698040347451-84a10cf0-b9ed-46ca-9140-9ce99d3343c8.png)
- order
，排序字段。手动填写数字设置，序号越大越靠前。
![商品排序设置界面](assets/images/learning/database/database-entity-design-product-information/1698040347902-328cdd3e-14f9-4a04-940b-b2c0abc46cd7.png)
- messages
，留言表单数组配置。
![留言表单配置界面1](assets/images/learning/database/database-entity-design-product-information/1698040348001-047ec4f1-a73b-4480-bcfc-7927d0b55be4.png)
![留言表单配置界面2](assets/images/learning/database/database-entity-design-product-information/1698040348086-c0d5b6cc-d026-4803-bc99-edc0a3a9c1b5.png)
...
etdDays
。
![预售发货设置界面](assets/images/learning/database/database-entity-design-product-information/1698040348166-32733144-a8d8-4982-a680-a0efde8f1419.png)
...
，Item 编号，1：1 指向对应的 Item 。
-
![购买权限设置界面](assets/images/learning/database/database-entity-design-product-information/1698040348263-e1cba3b0-35bf-4b73-ac1e-d699fb4eec47.png)
...
![ItemSku实体结构图](assets/images/learning/database/database-entity-design-product-information/1698040348342-8d37572c-a321-44a6-a1b9-802a7d3d0aa1.png)
...
![规格属性编号示例](assets/images/learning/database/database-entity-design-product-information/1698040348431-c3f63c49-6816-4344-aaa2-053443aa7a57.png)
...
![微店规格属性设计](assets/images/learning/database/database-entity-design-product-information/1698040348511-471c7f5d-cf13-4e75-b07a-95a60f535459.png)
...
- 男装>>背心/马甲
![淘宝男装规格属性](assets/images/learning/database/database-entity-design-product-information/1698040348595-2dd98e3a-6f5d-4dea-929f-9128a379632c.png)
- 箱包皮具/热销女包/男包>>卡包
![淘宝箱包规格属性](assets/images/learning/database/database-entity-design-product-information/1698040348676-ec3ef1a6-784d-4274-9a35-4d5282f7fc6e.png)

不同于有赞、微店，淘宝、京东是支持全平台进行检索，而有赞、微店是没有这方面的需求。

![淘宝商品属性搜索界面](assets/images/learning/database/database-entity-design-product-information/1698040348761-7bac6e45-8f93-4363-a323-9abd99f71bf8.png)
...
![淘宝商品属性类型](assets/images/learning/database/database-entity-design-product-information/1698040348868-0ea9a566-0c9b-4dce-b277-d956fef372ab.png)
...
![ItemAPI类结构图](assets/images/learning/database/database-entity-design-product-information/1698040348958-14b0e3f0-dd4d-48bf-91dc-3682464fd56a.png)
...
![ItemSkuAPI类结构图](assets/images/learning/database/database-entity-design-product-information/1698040349044-c6e02d9a-c247-4b44-a561-8c85901056f6.png)
