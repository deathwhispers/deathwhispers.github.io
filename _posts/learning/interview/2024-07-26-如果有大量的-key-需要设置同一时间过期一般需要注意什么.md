---
layout: post
title: 如果有大量的 key 需要设置同一时间过期，一般需要注意什么？
slug: interview-if-there-are-many-keys-need-to-set-expiration-time-at-the-same-time-what-should-we-pay-attention-to
date: 2024-07-26
type:
  - note
tags:
