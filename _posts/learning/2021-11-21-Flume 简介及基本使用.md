...
date: 2021-11-21
slug: flume-introduction-and-basic-usage
categories:
- General
tags:
- EngineeringPractice
type: note
status: draft
created: 2021-11-21 10:00
updated: 2021-11-21 10:00
week: 2021-W48
---
...
![Flume 基本架构图](assets/images/learning/Flume简介及基本使用/1698028738115-df63af8b-5ea2-4c23-a536-f326932477e6.png)
...
![multi-agent flow 架构](assets/images/learning/Flume简介及基本使用/1698028738299-07e2e2d3-f90f-4cf1-84ed-c8e83e6f269d.png)
...
![Consolidation 架构](assets/images/learning/Flume简介及基本使用/1698028738385-54d0d402-2932-4666-840d-316482c3dae6.png)

日志收集中常常存在大量的客户端（比如分布式 web 服务），Flume 支持使用多个 Agent 分别收集日志，然后通过一个或者多个 Agent 聚合后再存储到文件系统中。

### 3.3 Multiplexing the flow

![Multiplexing the flow 架构](assets/images/learning/Flume简介及基本使用/1698028738475-a75725f9-daa4-40c5-8bca-49e1c339da2f.png)
...
![向文件追加数据](assets/images/learning/Flume简介及基本使用/1698028738577-d557e862-490e-4e89-bb1f-7aa66a126182.png)

控制台的显示：

![控制台显示输出](assets/images/learning/Flume简介及基本使用/1698028738660-d3bb8778-eef1-4bc5-90d7-4425f1fb1ae7.png)
...
![文件上传日志](assets/images/learning/Flume简介及基本使用/1698028738736-9e7f58c4-569d-4897-8310-a4237bb6b8b6.png)
...
![HDFS文件内容](assets/images/learning/Flume简介及基本使用/1698028738818-a6993576-195a-4907-b313-619898f8b6c9.png)
...
![Flume 启动日志](assets/images/learning/Flume简介及基本使用/1698028738894-c56226d2-2e85-4aa6-a577-ffb8f6c78f43.png)

### 4.测试

向文件 tmp/log.txt 中追加内容：

![追加文件内容](assets/images/learning/Flume简介及基本使用/1698028738992-c60991c1-ed9c-4fcc-acb5-746189dee3c4.png)

可以看到已经从 8888 端口监听到内容，并成功输出到控制台：

![控制台输出](assets/images/learning/Flume简介及基本使用/1698028739093-6f19f6c1-362d-4621-8328-122ef15ac17f.png)
