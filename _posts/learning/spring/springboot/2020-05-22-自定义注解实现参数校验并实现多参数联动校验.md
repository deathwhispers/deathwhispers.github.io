...
public @interface Blank {
    ...
    {
        javax.validation.constraints.Blank.message;
    }
";
...
public class TestReq {
    ...
    @Blank(message = "等级为空时,code 应同时为空", groups =
    {
        WhenLevelIsBlank.class;
    }
)
@NotBlank(message = "等级不空时,code 不应为空", groups =
{
    WhenLevelNotBlank.class;
}
)
