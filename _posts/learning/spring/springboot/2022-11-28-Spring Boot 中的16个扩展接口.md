---
layout: post
title: Spring Boot 中的16个扩展接口
slug: spring-boot-extension-interfaces
type:
- note
date: 2022-11-28
week: 2022-W48
...
created: 2022-11-28 09:57
updated: 2022-11-28 09:57
categories:
- Learning
- Spring
---
...
![a1bf4d2d6af253237594db8e5819d777](/assets/images/learning/spring/springboot/spring-boot-extension-interfaces/a1bf4d2d6af253237594db8e5819d777.png)
...
：该触发点发生在
postProcessBeforeInstantiation
之前(在图上并没有标明，因为一般不太需要扩展这个点)，这个方法用于预测Bean的类型，返回第一个预测成功的Class类型，如果不能预测返回null；当你调用
...
![2eaefd4f66a89d10018c15aba611b345](/assets/images/learning/spring/springboot/spring-boot-extension-interfaces/2eaefd4f66a89d10018c15aba611b345.png)
...
用于获取基于
String
类型的properties的变量，一般我们都用
@Value
的方式去获取，如果实现了这个Aware接口，把
StringValueResolver
缓存起来，通过这个类去获取
String
类型的变量，效果是一样的。
...
的一个扩展类，
ResourceLoader
可以用于获取classpath内所有的资源对象，可以扩展此类来拿到
ResourceLoader
对象。
...
的一个扩展类，
ApplicationContext
应该是很多人非常熟悉的一个类了，就是spring上下文管理器，可以手动的获取任何在spring上下文注册的bean，我们经常扩展这个接口来缓存spring上下文，包装成静态方法。同时
ApplicationContext
也实现了
BeanFactory
，
