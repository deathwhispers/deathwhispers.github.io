---
layout: post
title: IOC-加载Bean：创建Bean（六）之初始化Bean对象
slug: ioc-initialize-bean-object
type:
- note
date: 2020-09-09
status: draft
...
created: 2020-09-09 09:00
updated: 2020-09-09 18:00
categories:
- Learning
- Spring
---
...
- 首先，检查是否为 InitializingBean 。如果**是**
的话，需要执行
#afterPropertiesSet()
方法，因为我们除了可以使用
init-method
来自定初始化方法外，还可以实现 InitializingBean 接口。接口仅有一个
#afterPropertiesSet()
方法。
- 两者的执行先后顺序是先
<1>
