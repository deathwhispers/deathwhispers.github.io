---
layout: post
title: IOC-深入分析Aware接口
author: deathwhispers
date: 2020-10-11
slug: ioc-deep-dive-into-aware-interface
categories:
- Spring
tags:
- Spring
...
type: note
status: draft
created: 2020-10-11 09:00
updated: 2020-10-11 18:00
---

**本文主要基于 Spring 5.0.6.RELEASE**

摘要: 原创出处 [http://cmsblogs.com/?p=3335](http://cmsblogs.com/?p=3335) 「小明哥」，谢谢！
...
![242d5c99b48d717a4e1ce7782cb57bab](/assets/images/learning/spring/springsourcecode/ioc-deep-dive-into-aware-interface/242d5c99b48d717a4e1ce7782cb57bab.png)
...
![cf1b7d54fc734e654a88c4611c6a5c34](/assets/images/learning/spring/springsourcecode/ioc-deep-dive-into-aware-interface/cf1b7d54fc734e654a88c4611c6a5c34.png)
...
```plain text
java public static void main(String[] args) {     ApplicationContext applicationContext = new ClassPathXmlApplicationContext("spring.xml");     MyApplicationAware applicationAware = (MyApplicationAware) applicationContext.getBean("myApplicationAware");     applicationAware.display(); }
```
...
![cf1b7d54fc734e654a88c4611c6a5c34](assets/images/learning/spring/springsourcecode/2020-05-22-ioc-deep-dive-into-aware-interface/cf1b7d54fc734e654a88c4611c6a5c34.png)
