...
![项目结构](/assets/images/learning/dubbo/dubbo-project-structure-overview/e43390470a308164cb9266921f2aa9df.png)
...
![Statistic统计代码量](/assets/images/learning/dubbo/dubbo-project-structure-overview/44d7161a72a902a1981faa14bc803fd6.png)
...
![Shell脚本统计代码量](/assets/images/learning/dubbo/dubbo-project-structure-overview/7fd2c3a7f04d308f3044514359502bb2.png)
...
![模块分包](/assets/images/learning/dubbo/dubbo-project-structure-overview/24c4c3a712400acc2d3120d13b6e71b2.png)
...
![dubbo-common包结构](/assets/images/learning/dubbo/dubbo-project-structure-overview/dd96060a886fc8a93f598df20c49913d.png)
...
![dubbo-remoting包结构](/assets/images/learning/dubbo/dubbo-project-structure-overview/755ecc04e8336d998032b12b115589fb.png)

*dubbo-remoting 包结构*

- `dubbo-remoting-zookeeper`，相当于 Zookeeper Client，和 Zookeeper Server 通信。
- `dubbo-remoting-api` **接口**，定义了 Dubbo Client 和 Dubbo Server 的。
...
![dubbo-rpc包结构](/assets/images/learning/dubbo/dubbo-project-structure-overview/cb9564aa318f57db202e4fadf67f9a80.png)

*dubbo-rpc 包结构*

- `dubbo-rpc-api` **抽象实现**，各种协议以及动态代理，了一对一的调用。
...
![dubbo-cluster包结构](/assets/images/learning/dubbo/dubbo-project-structure-overview/78a82897908fe1113c4473642dfb49ab.png)
...
![集群容错](/assets/images/learning/dubbo/dubbo-project-structure-overview/4940004347d7b1910855ffbe746b9aa7.png)
...
![dubbo-registry包结构](/assets/images/learning/dubbo/dubbo-project-structure-overview/de433bf9b5a225926d6213bc79544cc1.png)
...
![dubbo-monitor包结构](/assets/images/learning/dubbo/dubbo-project-structure-overview/7fe169f555b8176deb0e8d12cf4794dc.png)
...
![dubbo-config包结构](/assets/images/learning/dubbo/dubbo-project-structure-overview/ac183bfd33578bc88b804e0c14d3743e.png)
...
![dubbo-container包结构](/assets/images/learning/dubbo/dubbo-project-structure-overview/631facbaa74556b4ae2c39980d22996e.png)

*dubbo-container 包结构*

- `dubbo-container-api` [com.alibaba.dubbo.container.Container](https://github.com/alibaba/dubbo/blob/4bbc0ddddacc915ddc8ff292dd28745bbc0031fd/dubbo-container/dubbo-container-api/src/main/java/com/alibaba/dubbo/container/Container.java)：定义了接口，并提供 加载所有容器启动的 Main 类。
...
![dubbo-filter包结构](/assets/images/learning/dubbo/dubbo-project-structure-overview/3ce8aaf81e3abf9f19c0d57dba451158.png)
...
![dubbo-plugin包结构](/assets/images/learning/dubbo/dubbo-project-structure-overview/21575c4fa3eaead299f9078cd28b9cd3.png)
...
![hessian-lite提交历史](/assets/images/learning/dubbo/dubbo-project-structure-overview/76da26b98865db0688c91ecd17e6e5ed.png)
...
![dubbo-test包结构](/assets/images/learning/dubbo/dubbo-project-structure-overview/a3de80baf429192b08c2469a6ddcfb2a.png)
...
![dubbo-dependencies-bom文件](/assets/images/learning/dubbo/dubbo-project-structure-overview/31b210bd3c06133a926bec0ad3ee500e.png)
...
![引入dubbo-dependencies-bom文件](/assets/images/learning/dubbo/dubbo-project-structure-overview/baef34857d192acb5b4d2045b2b15509.png)
...
![dubbo-bom文件](/assets/images/learning/dubbo/dubbo-project-structure-overview/09fdbc0950bdec3f7124716a2c506509.png)
...
![引入dubbo-bom文件](/assets/images/learning/dubbo/dubbo-project-structure-overview/9e5fe965d729f3821e8afe0e3766286d.png)
...
![引入dubbo-parent文件](/assets/images/learning/dubbo/dubbo-project-structure-overview/7c0aed1b8e806ded3911c67b0b67736e.png)
...
![引入关系](/assets/images/learning/dubbo/dubbo-project-structure-overview/c736c82f84c5e36965223a0e66585e20.png)
