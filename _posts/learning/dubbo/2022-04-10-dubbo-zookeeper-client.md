...
```plain text
plain <dubbo:registry address="zookeeper://127.0.0.1:2181" client="curator" />
```
...
```plain text
plain <dubbo:registry address="zookeeper://127.0.0.1:2181" client="zkclient" />
```
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698038313971-14b9b240-4fdb-4aff-b1de-80cb003cc5aa.png)
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698038314081-e26896b2-d846-4dc1-be91-c6442de5317d.png)
