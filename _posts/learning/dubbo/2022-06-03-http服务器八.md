...
![代码结构](/assets/images/learning/dubbo/dubbo-http-server/2eba57cb7b90cfe01da5cc6f0a568abb.png)
...
- 实现层：
    ...
    - servlet 包：基于**外部的** Servlet Bridge Server 实现。简单的说，使用 war 包，部署在 Tomcat 、Jetty 等 Servlet 容器。
...
![类图](/assets/images/learning/dubbo/dubbo-http-server/4469223badaf5732deb8c71a627855dd.jpeg)
...
![流程](/assets/images/learning/dubbo/dubbo-http-server/1809aec41ae66ab7797c9fbb2d2b26ae.png)
...
- EXTERNAL_SERVER_PORT **静态**属性，外部服务器端口，用于 servlet 的服务器端口。
...
- **注意**，在配置的端口，和外部的 Servlet 容器的端口，需要**保持一致**。
