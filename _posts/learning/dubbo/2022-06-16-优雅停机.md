...
- <1>**READONLYEVENT**：参见 [《精尽 Dubbo 源码分析 —— NIO 服务器（四）之 Exchange 层》](http://svip.iocoder.cn/Dubbo/remoting-api-exchange/?self=) 的 [「4.1.4 优雅关闭」](http://svip.iocoder.cn/Dubbo/graceful-shutdown/#)
<2>
：基于
事件，在
中，见 HeaderExchangeServer 的
。
- <3>：参见 [《精尽 Dubbo 源码分析 —— NIO 服务器（四）之 Exchange 层》](http://svip.iocoder.cn/Dubbo/remoting-api-exchange/?self=) 的 [「2.1.2 发送请求」「2.1.3 优雅关闭」](http://svip.iocoder.cn/Dubbo/graceful-shutdown/#)
<4>
：在
...
- **绿优雅**框部分：HeaderExchangeServer 的关闭流程，详细解析见 [《精尽 Dubbo 源码分析 —— NIO 服务器（四）之 Exchange 层》](http://svip.iocoder.cn/Dubbo/remoting-api-exchange/?self=) 的 [「4.1.4 优雅关闭」](http://svip.iocoder.cn/Dubbo/graceful-shutdown/#)。
- **黄真正服务器**框部分：NettyServer 关闭 Netty 相关组件，详细解析见 [《精尽 Dubbo 源码分析 —— NIO 服务器（六）之 Netty4 实现》](http://svip.iocoder.cn/Dubbo/remoting-impl-netty4//?self=) 的 [「关闭服务器」](http://svip.iocoder.cn/Dubbo/graceful-shutdown/#)。
...
- **红优雅**框部分：HeaderExchangeClient 的关闭流程，详细解析见 [《精尽 Dubbo 源码分析 —— NIO 服务器（四）之 Exchange 层》](http://svip.iocoder.cn/Dubbo/remoting-api-exchange/?self=) 的 [「2.1.3 优雅关闭」](http://svip.iocoder.cn/Dubbo/graceful-shutdown/#)。
