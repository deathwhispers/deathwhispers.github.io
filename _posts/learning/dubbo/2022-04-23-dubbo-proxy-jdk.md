...
```plain text
plain // 服务引用 <dubbo:reference proxy="jdk" />  // 服务暴露 <dubbo:service proxy="jdk" />
```
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698038319077-d760b54f-f48b-49be-aeb5-ca97fcc09fb9.png)
