...
- cluster**真正所以对应的 Cluster 对象，都会被它所包装**，参见 [《精尽 Dubbo 源码分析 —— 拓展机制 SPI》](http://svip.iocoder.cn/Dubbo/spi/?self=) 的 [「4.4.2 createExtension」](http://svip.iocoder.cn/Dubbo/cluster-8-impl-mock/#)
字段，
