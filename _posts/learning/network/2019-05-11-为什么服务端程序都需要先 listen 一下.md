---
layout: post
title: 为什么服务端程序都需要先 listen 一下？
slug: why-do-server-programs-need-to-listen-first
type:
  - note
date: 2019-05-11
status: draft
...
5. min (backlog, somaxconn) = min (512, 128) = 128
6. min (128, tcp_max_syn_backlog) = min (128, 8192) = 128
7. max (128, 8) = 128
8. roundup_pow_of_two (128 + 1) = 256
