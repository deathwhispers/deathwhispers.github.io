...
![](/assets/images/learning/bigdata/hbase/hbase-system-architecture-and-data-structure/33a90296590577f652d408daa72d3c58.png)
...
![](/assets/images/learning/bigdata/hbase/hbase-system-architecture-and-data-structure/f95e75e89e9994729b90b2cdc004de4b.png)

每个表一开始只有一个 Region，随着数据不断增加，Region 会不断增大，当增大到一个阀值的时候，Region 就会等分为两个新的 Region。当 Table 中的行不断增多，就会有越来越多的 Region。

![](/assets/images/learning/bigdata/hbase/hbase-system-architecture-and-data-structure/c15a6f92b73877da3aac54157f486f50.png)

Region 是 HBase 中**分布式存储和负载均衡的最小单元**。这意味着不同的 Region 可以分布在不同的 Region Server 上。但一个 Region 是不会拆分到多个 Server 上的。

![](/assets/images/learning/bigdata/hbase/hbase-system-architecture-and-data-structure/b983e480357dbec6a0630b7433a5d18f.png)
...
![](/assets/images/learning/bigdata/hbase/hbase-system-architecture-and-data-structure/e9bdbc92ec67c2c9d81f000981362971.png)
...
![](/assets/images/learning/bigdata/hbase/hbase-system-architecture-and-data-structure/b788ec5e4713a082690a4c7b0b862fea.png)
...
![](/assets/images/learning/bigdata/hbase/hbase-system-architecture-and-data-structure/33433bd9fa859cc64d57b06d09026f5b.png)
...
![](/assets/images/learning/bigdata/hbase/hbase-system-architecture-and-data-structure/fd1196ff51e874204f50f0abf0a55eba.png)
...
![](/assets/images/learning/bigdata/hbase/hbase-system-architecture-and-data-structure/85bfc6d4aa670fddf761f76af306e222.png)
