...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698027537967-dc45df70-ff1e-4c42-8043-3bdd0176e4b7.png)
...
表的位置信息，Master 的信息；
- **HBase Master**
：主要用于执行 HBaseAdmin 接口的一些操作，例如建表等；
- **HBase RegionServer**
：用于读、写数据。

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698027538049-b1b4696e-6b19-4523-afc0-d8adb6d18d2f.png)

Connection 对象和实际的 Socket 连接之间的对应关系如下图：

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698027538132-3642b697-e490-4664-9792-ff36a1185d1e.png)
