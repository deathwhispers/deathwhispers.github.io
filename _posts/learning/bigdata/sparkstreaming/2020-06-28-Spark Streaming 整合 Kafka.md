...
- **PreferConsistent**
: 它将在所有的 Executors 上均匀分配分区；
- **PreferBrokers**
: 当 Spark 的 Executor 与 Kafka Broker 在同一机器上时可以选择该选项，它优先将该 Broker 上的首领分区分配给该机器上的 Executor；
- **PreferFixed**
...
具体提交方式可以参见：[Kafka 消费者详解](https://github.com/heibaiying/BigData-Notes/blob/master/notes/Kafka%20%E6%B6%88%E8%B4%B9%E8%80%85%E8%AF%A6%E8%A7%A3.md)
...
1. [https://spark.apache.org/docs/latest/streaming-kafka-0-10-integration.html](https://spark.apache.org/docs/latest/streaming-kafka-0-10-integration.html)
