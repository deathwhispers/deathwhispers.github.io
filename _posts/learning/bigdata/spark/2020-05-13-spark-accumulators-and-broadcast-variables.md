---
layout: post
title: Spark 累加器与广播变量
slug: spark-accumulators-and-broadcast-variables
type:
  - note
date: 2020-05-13
status: draft
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029083708-0018fe3d-203f-48aa-898e-13b9dc524748.png)
...
- **x**
: 是一个绑定变量 (bound variable)，因为其是该函数的入参，在函数的上下文中有明确的定义；
- **more**
: 是一个自由变量 (free variable)，因为函数字面量本生并没有给 more 赋予任何含义。
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029083792-105512c3-15dd-423d-a245-9d5bce5c8c76.png)

### 2.2 使用累加器

SparkContext 中定义了所有创建累加器的方法，需要注意的是：被中横线划掉的累加器方法在 Spark 2.0.0 之后被标识为废弃。

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029083884-a32ddcb3-fd7d-4b4f-9738-2f42a6721ad1.png)
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029083960-d97ff87c-a363-41af-967e-072931393c43.png)
