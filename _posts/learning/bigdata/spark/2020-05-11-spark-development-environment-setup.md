...
layout: post
title: Spark 开发环境搭建
slug: spark-development-environment-setup
type:
  - note
date: 2020-05-11
status: draft
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029085302-197c8986-43f3-415c-89c9-96fad2bea578.png)
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029085387-d9d21fa5-0307-4818-8df6-8ec2ac827416.png)
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029085452-de20bbee-3814-455b-a9eb-cccb260a17d2.png)

同时还可以通过 Web UI 查看作业的执行情况，访问端口为 4040：

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029085519-5397445e-6585-44e2-8b0e-9bcca30e1bab.png)
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029085597-d2c60f42-cb5f-4462-a87b-ae322259a07e.png)

### 3.3 创建Scala项目

在 IDEA 中依次点击 **File** => **New** => **Project** 选项卡，然后选择创建 Scala—IDEA 工程：

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029085682-ad4bb56f-c4bc-48ec-8510-c2568a5bfe7c.png)
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029085752-1fdf2674-957f-4ba9-994c-5227643f761f.png)
...
![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029085838-04ffa8e8-eae2-4be1-b877-9f40199ea16f.png)

由于安装时已经自动配置好环境变量，所以 IDEA 会自动选择对应版本的 SDK。

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029085909-1663f290-050f-4152-902b-3b4fe7db5591.png)

### 3.5 创建Hello World

在工程 src 目录上右击 **New** => **Scala class** 创建 Hello.scala。输入代码如下，完成后点击运行按钮，成功运行则代表搭建成功。

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029086028-c2e9b7fe-a5bf-4749-9b04-d4c7671b5770.png)

### 3.6 切换Scala版本

在日常的开发中，由于对应软件（如 Spark）的版本切换，可能导致需要切换 Scala 的版本，则可以在 Project Structures 中的 Global Libraries 选项卡中进行切换。

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029086145-d6c7d6d7-1013-4356-9349-a2a333218a25.png)

### 3.7 可能出现的问题

在 IDEA 中有时候重新打开项目后，右击并不会出现新建 scala 文件的选项，或者在编写时没有 Scala 语法提示，此时可以先删除 Global Libraries 中配置好的 SDK，之后再重新添加：

![](https://cdn.nlark.com/yuque/0/2023/png/29230873/1698029086220-61d5c101-436f-4b39-bc54-63a17f14f036.png)
