...
| **mapPartitions**(*func*)                                                        | 与 map 类似，但函数单独在 RDD 的每个分区上运行， *func*函数的类型为 Iterator => Iterator<u> ，其中 T 是 RDD 的类型，即 RDD[T]</u>                                                                                                               |
| **mapPartitionsWithIndex**(*func*)                                               | 与 mapPartitions 类似，但 *func* 类型为 (Int, Iterator) => Iterator<u> ，其中第一个参数为分区索引</u>                                                                                                                              |
...
![d65d02c77e89a494e204e543c08dc7ec](/assets/images/learning/bigdata/spark/transformation-and-action-common-operators/d65d02c77e89a494e204e543c08dc7ec.png)
...
![2ea6fe7534564e1ee61b1f82ee6aa867](/assets/images/learning/bigdata/spark/transformation-and-action-common-operators/2ea6fe7534564e1ee61b1f82ee6aa867.png)
