...
layout: post
title: Hive 分区表和分桶表
slug: hive-partition-table-and-bucket-table
type:
- note
date: 2021-04-14
status: draft
...
![](/assets/images/learning/bigdata/hive/hive-partition-table-and-bucket-table/4f9454a51a75718e6e87a983ac62e9eb.png)
...
![](/assets/images/learning/bigdata/hive/hive-partition-table-and-bucket-table/62cb152a583d26f9c97cae3666e176e4.png)
...
![](/assets/images/learning/bigdata/hive/hive-partition-table-and-bucket-table/e98b46d987c1d2efdd34fea837301e3c.png)

### 1.5 查看分桶文件

bucket(桶) 本质上就是表目录下的具体文件：

![](/assets/images/learning/bigdata/hive/hive-partition-table-and-bucket-table/3eefd025da4156d4148620bbb602c128.png)
