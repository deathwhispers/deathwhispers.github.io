...
slug: hive-common-ddl-operations
type:
  - note
date: 2021-04-19
status: draft
...
![](/assets/images/learning/bigdata/hive/hive-common-ddl-operations/5468ade67a1c27138f14215e8d4903e2.png)
...
![](/assets/images/learning/bigdata/hive/hive-common-ddl-operations/dbf203af7c0b1a6f089525e5bdff8602.png)
...
```sql
-- 加载数据到 emp 表中load data local inpath "/usr/file/emp.txt" into table emp;
```
...
![](/assets/images/learning/bigdata/hive/hive-common-ddl-operations/bb84a05e5d273ed5d01dfa2bd757b96d.png)
