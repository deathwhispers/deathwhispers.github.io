...
slug: hive-common-dml-operations
type:
- note
date: 2021-04-21
status: draft
...
- LOCAL
关键字代表从本地文件系统加载文件，省略则代表从 HDFS 上加载文件：
- 从本地文件系统加载文件时，
filepath
可以是绝对路径也可以是相对路径 (建议使用绝对路径)；
- 从 HDFS 加载文件时候，
filepath
为文件完整的 URL 地址：如
...
![](/assets/images/learning/bigdata/hive/hive-common-dml-operations/1ee3222669f6c7d59a8c8666c94f3346.png)
...
![](/assets/images/learning/bigdata/hive/hive-common-dml-operations/d071195591bfaaeed19c1fe7642a8d11.png)
...
![](/assets/images/learning/bigdata/hive/hive-common-dml-operations/be456000f1e2b58ef1b3e9d4274f5deb.png)
...
![](/assets/images/learning/bigdata/hive/hive-common-dml-operations/1019a581278d263a907bd3e05cbf4bba.png)
...
![](/assets/images/learning/bigdata/hive/hive-common-dml-operations/7cb896858aa2de461490b88241def198.png)
...
![](/assets/images/learning/bigdata/hive/hive-common-dml-operations/323dd03ec240f24abc05fc753959a7ef.png)
...
![](/assets/images/learning/bigdata/hive/hive-common-dml-operations/62158ef5e2bf6c75c4759f9b99e48896.png)

## 参考资料

5. [Hive Transactions](https://cwiki.apache.org/confluence/display/Hive/Hive+Transactions)
6. [Hive Data Manipulation Language](https://cwiki.apache.org/confluence/display/Hive/LanguageManual+DML)
