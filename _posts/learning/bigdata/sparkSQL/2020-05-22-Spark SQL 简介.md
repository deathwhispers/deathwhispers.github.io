...
![Spark SQL 架构](/assets/images/learning/bigdata/sparkSQL/spark-sql-introduction/5bbf7ba76810fd8b4fa9717377222117.png)
...
![DataFrame 与 RDD 内部结构对比](/assets/images/learning/bigdata/sparkSQL/spark-sql-introduction/5267c8845ec80c97ae527acb1f6cfe24.png)
...
![DataFrame 与 DataSet API 关系](/assets/images/learning/bigdata/sparkSQL/spark-sql-introduction/89a562e648f853cf3f2cabcd27a1e06c.png)
...
![类型安全图谱](/assets/images/learning/bigdata/sparkSQL/spark-sql-introduction/2eaa21cbcef3a8fb737398bbc8811492.png)

上面的描述可能并没有那么直观，下面的给出一个 IDEA 中代码编译的示例：

![IDEA 代码编译示例](/assets/images/learning/bigdata/sparkSQL/spark-sql-introduction/0542231cf2aed6ffee1b1d2e71c821c8.png)
...
![DataFrame、DataSet 和 RDDs 关系](/assets/images/learning/bigdata/sparkSQL/spark-sql-introduction/c4e41c91915c012dbaae4c96f17ffb12.png)
...
![逻辑计划执行流程](/assets/images/learning/bigdata/sparkSQL/spark-sql-introduction/1faee896acc323778258dfcb8636d70c.png)
...
![物理计划执行流程](/assets/images/learning/bigdata/sparkSQL/spark-sql-introduction/938dd01ae73314aa5e2f3a9aa2f40ddc.png)
...
5. Matei Zaharia, Bill Chambers . Spark: The Definitive Guide[M] . 2018-02
6. [Spark SQL, DataFrames and Datasets Guide](https://spark.apache.org/docs/latest/sql-programming-guide.html)
7. [且谈 Apache Spark 的 API 三剑客：RDD、DataFrame 和 Dataset(译文)](https://www.infoq.cn/article/three-apache-spark-apis-rdds-dataframes-and-datasets)
8. [A Tale of Three Apache Spark APIs: RDDs vs DataFrames and Datasets(原文)](https://databricks.com/blog/2016/07/14/a-tale-of-three-apache-spark-apis-rdds-dataframes-and-datasets.html)
