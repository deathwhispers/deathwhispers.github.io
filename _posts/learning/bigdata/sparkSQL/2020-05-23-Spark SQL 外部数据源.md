...
date: 2020-05-23
slug: spark-sql-external-data-sources
categories:
- BigData
tags:
- BigData
...
![JDBC 分区验证结果](/assets/images/learning/bigdata/sparkSQL/spark-sql-external-data-sources/199b5b1cd1031c2ef4bc57585cdce945.png)
...
![分区写入结果](/assets/images/learning/bigdata/sparkSQL/spark-sql-external-data-sources/a3cd2d36abffe3affd9d29911b2ffe5e.png)
...
| Both | compression or codec | None,uncompressed,bzip2, deflate,gzip, lz4, orsnappy | none | 文件压缩格式 |
...
| 读 | 配置项 | 可选值 | 默认值 |
| --- | --- | --- | --- |
| Both | compression or codec | None,uncompressed,bzip2, deflate,gzip, lz4, orsnappy | none |
