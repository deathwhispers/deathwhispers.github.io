...
![有状态计算示意图](/assets/images/learning/bigdata/flink/flink-state-management/5e429e7818709658c12b1f439adcdb5d.png)
...
![算子状态示意图](/assets/images/learning/bigdata/flink/flink-state-management/69683af99192a8bca1481713a4fdc4c1.png)
...
![键控状态示意图](/assets/images/learning/bigdata/flink/flink-state-management/3d2590878f796184f2d7c679757088b7.png)
...
![阈值报警输出结果](/assets/images/learning/bigdata/flink/flink-state-management/908c41829326722af99c12b562898e42.png)
...
![状态实例hashcode输出](/assets/images/learning/bigdata/flink/flink-state-management/0ff3dffcdb73059eef3bcccfb9a00fe0.png)

在上面的调用代码中，我们将程序的并行度设置为 1，可以看到三次输出中状态实例的 hashcode 全是一致的，证明它们都同一个状态实例。假设将并行度设置为 2，此时输出如下：

![并行度为2时的输出](/assets/images/learning/bigdata/flink/flink-state-management/f8eb08d76c7e92d83124c02c8d6424fc.png)
...
![检查点机制示意图](/assets/images/learning/bigdata/flink/flink-state-management/25252274012138d770f37968fcb1d63d.png)
...
![状态后端分类](/assets/images/learning/bigdata/flink/flink-state-management/a101efecf927130bb28b8c4a8da4f1db.png)
