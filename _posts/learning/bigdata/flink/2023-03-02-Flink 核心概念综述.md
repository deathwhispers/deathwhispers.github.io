...
![](/assets/images/learning/bigdata/flink/flink-core-concepts-overview/5d5f888831c89e9960eb384b295d308b.png)

Spark Streaming 数据流的拆分：

![](/assets/images/learning/bigdata/flink/flink-core-concepts-overview/97be2fa2f5183fc8eaab940195fbc0f0.png)

## 二、Flink 核心架构

Flink 采用分层的架构设计，从而保证各层在功能和职责上的清晰。如下图所示，由上而下分别是 API & Libraries 层、Runtime 核心层以及物理部署层：

![](/assets/images/learning/bigdata/flink/flink-core-concepts-overview/0fd8e56c07a65ada9dabcf9448accd42.png)
...
![](/assets/images/learning/bigdata/flink/flink-core-concepts-overview/6ed3ac2402a5cf223f8c0a1124eab02c.png)
...
![](/assets/images/learning/bigdata/flink/flink-core-concepts-overview/c75b4c480d2c68580e3af3ae9b123414.png)
...
![](/assets/images/learning/bigdata/flink/flink-core-concepts-overview/4ec4a546065fff24a58ec77b403efed5.png)
...
![](/assets/images/learning/bigdata/flink/flink-core-concepts-overview/87925cae4bbd1f49b15e49668ff8084f.png)

这时每个 SubTask 线程运行在一个独立的 TaskSlot， 它们共享所属的 TaskManager 进程的TCP 连接（通过多路复用技术）和心跳信息 (heartbeat messages)，从而可以降低整体的性能开销。此时看似是最好的情况，但是每个操作需要的资源都是不尽相同的，这里假设该作业 keyBy 操作所需资源的数量比 Sink 多很多 ，那么此时 Sink 所在 Slot 的资源就没有得到有效的利用。

基于这个原因，Flink 允许多个 subtasks 共享 slots，即使它们是不同 tasks 的 subtasks，但只要它们来自同一个 Job 就可以。假设上面 souce & map 和 keyBy 的并行度调整为 6，而 Slot 的数量不变，此时情况如下：

![](/assets/images/learning/bigdata/flink/flink-core-concepts-overview/42a2761f53dc1ca59ff717e210de4d7a.png)
...
![](/assets/images/learning/bigdata/flink/flink-core-concepts-overview/ab89e0ebac16af7ab8e14adf8d8e3bd6.png)
...
![](/assets/images/learning/bigdata/flink/flink-core-concepts-overview/fe3a714e647a79a121b316b5d87b677f.png)
