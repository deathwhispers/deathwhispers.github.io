...
![Sqoop help 命令输出](../../assets/images/learning/sqoop-basic-usage/a63b7a46cba0d2ea952d6a94f97cfb10.png)
...
![Sqoop list-databases 命令输出](../../assets/images/learning/sqoop-basic-usage/e5d9653d031d1113c28a861254ed6f32.png)
...
![Sqoop import 日志输出](../../assets/images/learning/sqoop-basic-usage/9443224e25fe5eee88a4de3314667f7f.png)
...
![HDFS 导入目录结构](../../assets/images/learning/sqoop-basic-usage/8197167fd47438e6d92503cf58e1f28d.png)
...
![Hive 表数据查询结果](../../assets/images/learning/sqoop-basic-usage/5b261178c42d7856326c9fab6bbc0473.png)

### 3. 可能出现的问题

![Hive 导入错误截图](../../assets/images/learning/sqoop-basic-usage/503e173bfa05926e73677c3a5dcb70fc.png)
...
![Hive 表 HDFS 存储位置](../../assets/images/learning/sqoop-basic-usage/98733a9d2dc10447abe18ffaf974ac53.png)

这里可以查看一下这个目录，文件结构如下：

![HDFS 目录文件结构](../../assets/images/learning/sqoop-basic-usage/c6b737f67c0efd968fc5b4b2b0773487.png)
...
![HBase scan 查看表数据](../../assets/images/learning/sqoop-basic-usage/979b045b610fc1548113540a8fcf1143.png)
