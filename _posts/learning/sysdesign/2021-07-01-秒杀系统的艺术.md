...
type: note
status: draft
created: 2021-06-24 10:00
updated: 2021-06-24 10:00
week: 2021-W27
---
...
笔者专门研究了一下"12306"的服务端架构，学习到了其系统设计上很多亮点，在这里和大家分享一下并模拟一个例子：如何在 100 万人同时抢 1 万张火车票时，系统提供正常、稳定的服务。github代码地址
...
![高并发系统架构示意图](/assets/images/learning/sysdesign/seckill-system-art/4529779cc76d37bbaff96d8ecd147082.png)
...
我在本地 /etc/hosts 目录下配置了www.load_balance.com 的虚拟域名地址。
...
具体的实现大家可以参考 Nginx 的 Upsteam 模块实现源码：
...
从上面的介绍我们知道用户秒杀流量通过层层的负载均衡，均匀到了不同的服务器上，即使如此，集群中的单机所承受的 QPS 也是非常高的。
...
![下单减库存流程](/assets/images/learning/sysdesign/seckill-system-art/a5f58a4378be9710998c5214b1edd568.png)
...
![支付减库存流程](/assets/images/learning/sysdesign/seckill-system-art/66e0ac083f3d77c9e4dbdda7bff9bae3.png)
...
![预扣库存流程](/assets/images/learning/sysdesign/seckill-system-art/2ac780aa6ae784041e2d9da9757f4880.png)
...
![单机扣库存流程](/assets/images/learning/sysdesign/seckill-system-art/99b67d436def19bf3c5d6fae4ccd0a16.png)
...
![本地扣库存优化流程](/assets/images/learning/sysdesign/seckill-system-art/5ba8d79643ad1a298ac39b03a5f3cf87.png)
...
![集群架构示意图](/assets/images/learning/sysdesign/seckill-system-art/5c981f77ca35f015df86a5993735fd02.png)
...
![Redis统一库存架构图](/assets/images/learning/sysdesign/seckill-system-art/9e2ed23ca377dba295711f749a3bf6fd.png)
