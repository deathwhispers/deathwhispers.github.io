...
![](/assets/images/learning/sysdesign/risk-control-system-design/b03524c5a66e4c16b12e501f8548a81d.jpeg)

要想回答这个问题,需要先解释下我们业务需要用到的风控(简称业务风控),与开源常见的风控(简称普通风控)有何区别:

![](/assets/images/learning/sysdesign/risk-control-system-design/ffbfc16779bb7331e944420ae37f0676.png)
...
class DetectHandler {
    ...
    fun operatorAnnotation(joinPoint: ProceedingJoinPoint, detect: Detect): Any? {
        ...
        //转换表达式
       val expression = spelExpressionParser.parseExpression(detect.contentSpel)        val argMap = joinPoint.args.mapIndexed { index, any ->                                                "arg${index+1}" to any
                                               }.toMap()
...
![](/assets/images/learning/sysdesign/risk-control-system-design/602dec83f701c65c3098881fe187d5e0.jpeg)
