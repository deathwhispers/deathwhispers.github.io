...
![SSO核心应用与依赖架构图](/assets/images/learning/sysdesign/sso-single-sign-on/c4e367ed27223f3bfc3217a808974f86.png)
...
![用户登录时序图](/assets/images/learning/sysdesign/sso-single-sign-on/b21dcacfd58fa778548d41674a7c9a87.png)
...
![登录信息获取/登录状态校验时序图](/assets/images/learning/sysdesign/sso-single-sign-on/42a9a348d225ec2ea36b1a32b9df86d6.png)

### 4、用户登出

用户登出时要做的事情很简单：

4. 服务端清除缓存（Redis）中的登录状态
5. 客户端清除存储的AuthToken
- 登出时序图

![用户登出时序图](/assets/images/learning/sysdesign/sso-single-sign-on/8f1718f65fd4db6978550a7bc96731ae.png)
...
![跨域登录（主域名已登录）时序图](/assets/images/learning/sysdesign/sso-single-sign-on/666009f99c589d8e16e382200f84c1c0.png)

- 跨域登录（主域名未登录）

![跨域登录（主域名未登录）时序图](/assets/images/learning/sysdesign/sso-single-sign-on/9e449bf6d48af7dab8fbc37380d287b0.png)

- 跨域登出

![跨域登出时序图](/assets/images/learning/sysdesign/sso-single-sign-on/d80fd84931a047c6a1eef5fbfc7a5429.png)
