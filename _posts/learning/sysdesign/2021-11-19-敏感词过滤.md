...
type: note
status: draft
created: 2021-11-19 10:00
updated: 2021-11-19 10:00
week: 2021-W48
---
...
![](/assets/images/learning/sysdesign/sensitive-word-filtering/db28e2d3a13f70012ca87f881dafbe48.png)
...
![](/assets/images/learning/sysdesign/sensitive-word-filtering/6b0c86081f979b30c34495641d4e253e.png)
...
![](/assets/images/learning/sysdesign/sensitive-word-filtering/62d05af194072e93f5d9deefa60df1d6.png)
...
assertEquals("
{
    Abi=doctor, Abigail=student;
}
", trie.prefixMap("Abi").toString());
assertEquals("
{
    Chris=doctor, Christina=student;
}
", trie.prefixMap("Chr").toString());
...
![](/assets/images/learning/sysdesign/sensitive-word-filtering/524b1a64f47a816471dd5cbbbd07331e.png)
...
- [ToolGood.Wordsopen in new window](https://github.com/toolgood/ToolGood.Words)
：一款高性能敏感词(非法词/脏字)检测过滤组件，附带繁体简体互换，支持全角半角互换，汉字转拼音，模糊搜索等功能。
- [sensitive-words-filteropen in new window](https://github.com/hooj0/sensitive-words-filter)
