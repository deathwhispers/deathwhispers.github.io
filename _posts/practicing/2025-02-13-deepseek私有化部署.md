...
![image.png](../../assets/images/practicing/deepseek私有化部署/ba56bd5d17812537c54a909667aa4ae4.png)

ollama -v 显示：

![image.png](../../assets/images/practicing/deepseek私有化部署/8246bc47b631e299c4169d0b2e532c52.png)
...
![image.png](../../assets/images/practicing/deepseek私有化部署/fb6fe4dc4f7c6547e1187f7883ebce17.png)
...
![image.png](../../assets/images/practicing/deepseek私有化部署/8f1004e8ffc1d70fe2ad8c339eb6dd65.png)

安装成功后的界面

![image.png](../../assets/images/practicing/deepseek私有化部署/5c02294eb8513f1630e0adc7d43b6d9b.png)

可以直接使用了，简单提问试一下：

![image.png](../../assets/images/practicing/deepseek私有化部署/22ae07530a15244203e73253a1e571d3.png)
...
![image.png](../../assets/images/practicing/deepseek私有化部署/089dc2ef8dbd8347cdbfaa3142c053ae.png)

点击扩展插件，就可以看到刚刚加载的插件，点击📌将插件固定到浏览器中，方便以后随时打开使用

![image.png](../../assets/images/practicing/deepseek私有化部署/8bffa62a332cbb1157206553745b413b.png)

点击插件图标就可以打开UI界面了，和chatGPT的聊天界面类似，可以选择对应的模型开始提问。

![image.png](../../assets/images/practicing/deepseek私有化部署/54ea850b3e3c82724f335fca6507a832.png)

点击模型下拉框，可以查看已经安装的模型，目前已经安装了1.5B和7B的deepseek蒸馏版模型。

![image.png](../../assets/images/practicing/deepseek私有化部署/3c09d4f4be1c598378cdfe40ae1b29b0.png)

接下来，可以选择一个模型提问试试

![image.png](../../assets/images/practicing/deepseek私有化部署/d684e71d1fdd79210162e1063cb26556.png)

此时服务器CPU情况，推理速度很慢，且服务器资源占用量很大。

![image.png](../../assets/images/practicing/deepseek私有化部署/bdfebca731ddc4eb8ccc1b4984c1c801.png)

点击右上角的齿轮进入设置页面，可以进行一些基础的设置，如语言，语音识别语言等等。

同时可以管理网络搜索，选择搜索引擎，是否默认联网搜索等。

![image.png](../../assets/images/practicing/deepseek私有化部署/31923f392c044fe3e8b397f633ea8c47.png)

![image.png](../../assets/images/practicing/deepseek私有化部署/d0d807770c355720dc46fc8a346d6a1a.png)

在"OpenAI 兼容 API"设置项中，会列出所有已添加的服务提供商，

![image.png](../../assets/images/practicing/deepseek私有化部署/71df7c40726eb28af8da176676e58594.png)

点击"添加提供商"可以添加新的大模型服务提供商

![image.png](../../assets/images/practicing/deepseek私有化部署/0a756509c03294aea0c115f02b038a81.png)

比如，选择"DeepSeek"，会自动带出提供商名称和基础URL，当然也可以修改；填入对应的API key就可以使用了。

![image.png](../../assets/images/practicing/deepseek私有化部署/2f910f37607cabfaf43d833c1281f09b.png)

添加完成后，点击下载按钮，可以下载对应的模型

![image.png](../../assets/images/practicing/deepseek私有化部署/8dfe694320cc26b7d51fe2b02acddf4b.png)

所有已下载的模型，可以在"管理模型"菜单中的 **Custom Models** 中列出

![image.png](../../assets/images/practicing/deepseek私有化部署/8de23c919569f564bad5d71563025574.png)

"管理知识"菜单栏，可以添加本地知识库，让DeepSeek更专业。

![image.png](../../assets/images/practicing/deepseek私有化部署/f029d472bd22d5151e37e37acdf99ef1.png)
